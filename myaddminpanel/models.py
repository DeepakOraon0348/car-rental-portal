...
class Driver(models.Model):
    vendor = models.ForeignKey(
        VendorLogin, on_delete=models.CASCADE, related_name="drivers"
    )
...
class Car(models.Model):
    ...
    vendor = models.ForeignKey(
        VendorLogin, on_delete=models.CASCADE, related_name="cars"
    )
...
class Booking(models.Model):
    ...
    vendor = models.ForeignKey(
        VendorLogin, on_delete=models.CASCADE, related_name="bookings"
    )

    car = models.ForeignKey(Car, on_delete=models.CASCADE, related_name="booking")
