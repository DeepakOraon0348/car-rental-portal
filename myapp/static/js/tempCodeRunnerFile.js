...
pickupDate.addEventListener('input', calculateAmount)

pickupTime.addEventListener('input', calculateAmount)

returnDate.addEventListener('input', calculateAmount)

returnTime.addEventListener('input', calculateAmount)